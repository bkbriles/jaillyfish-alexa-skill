...
"""
Grabbed this deployment script from user: github.com/youngsoul
...
deployment_files = ['AlexaBaseHandler.py', 'AlexaDeploymentHandler.py', 'main.py', 'jaillyfish-alexa-skill.py']
